...
#### 옵션 1: 릴리즈 파일 다운로드 (권장)
1. [Releases](https://github.com/Like-eit11/ETS2-Overlay/releases) 페이지에서 가장 최신 버전의 `Truck-Overlay.zip`을 다운로드합니다.
2. 원하는 폴더에 압축을 해제합니다.
...
#### 옵션 2: 소스 코드 클론 (개발자용)
```bash
git clone https://github.com/Like-eit11/ETS2-Overlay.git
cd ETS2-Overlay
npm install
```
